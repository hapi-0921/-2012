...
namespace GameLib
{
    ...
    namespace input
    {
        ...
        const int PAD_J = (1 << 16);
        const int PAD_K = (1 << 17);
        const int PAD_L = (1 << 18);
        const int LEFT_CLICK = (1 << 19);
        const int RIGHT_CLICK = (1 << 20);
        const int CENTER_CLICK = (1 << 21);
        const int PAD_SHIFT = (1 << 22);
