...
namespace GameLib
{
    ...
    namespace primitive
    {
        ...
        //  bool world      true:ワールド座標に描画 false : スクリーン座標に描画
        //--------------------------------------------------------------
        void circle(float, float, float, float sx = (1), float sy = (1), float angle = (0),
            float r = (1), float g = (1), float b = (1), float a = (1),
            int n = (32), bool world = (false));
        ...
        //  bool world              true:ワールド座標に描画 false : スクリーン座標に描画
        //--------------------------------------------------------------
        void circle(const VECTOR2&, float, const VECTOR2& scale = (VECTOR2(1, 1)), float angle = (0),
            const VECTOR4& color = (VECTOR4(1, 1, 1, 1)),
            int n = (PRIMITIVE_CIRCLE_SIDE_NUM), bool world = (false));
        ...
        void draw_triangle_fan(const VECTOR2[], const VECTOR4&, int nPolygon,
            bool world = (false));
    }
    ...
    {
        void init();        // ImGui初期化
        void newFrame();    // フレーム開始
        void render();      // ImGui描画
        void uninit();      // ImGui終了処理
    }
}
