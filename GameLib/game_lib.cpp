...
namespace GameLib
{
    ...
    namespace imgui
    {
        ...
        void init()
        {
            ...
            // カスタムカラー
            style.Colors[ImGuiCol_WindowBg] = ImVec4(0.05f, 0.05f, 0.1f, 0.95f);
            style.Colors[ImGuiCol_TitleBg] = ImVec4(0.1f, 0.1f, 0.2f, 1.0f);
            style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.15f, 0.15f, 0.3f, 1.0f);
